...
def fix_updates_layout(file_path):
    ...
    try:
        ...
        # 1. 找到更新日誌部分（有日期的）
        # 模式：包含log-date的更新記錄
        log_entry_pattern = r'(<div class="log-entry">\s*<div class="log-date">(.*?)</div>.*?)</div>\s*</div>\s*</div>'
        ...
        new_log_section = '<section class="content-card">
            <h2 class="section-title">📝 更新日誌</h2>
...
if __name__ == '__main__':
    fix_updates_layout('beapro-football-guide.html')
